<?php
   ...
   */
   $URL_CONFERMA = "http://localhost/esercizi/poi/validation/email.php?id=%d&p1=%s&p2=%s&p3=%s";
   $URL_RESET_PSW = "http://localhost/esercizi/poi/reset_password/verify.php?id=%d&p1=%s&p2=%s&p3=%s";
